...
export default function NGOPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-8 lg:p-12">
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-gray-50 rounded-xl p-4 border-l-4 border-green-500 shadow-sm ">
                    ...
                    <div className="bg-gray-50 border-l-4 border-blue-500 rounded-xl p-4 shadow-sm">
                      <div className="flex items-center gap-2 mb-1">
                        <svg
              ...
              {campaign.cause_statement && (
                <div className="mt-8 p-6 bg-gray-50 shadow-sm rounded-xl border-l-4 border-blue-500">
      ...
      <div className="">
         <DonationBar campaignId={campaign.id} campaignTitle={campaign.title}/>
      </div>
    </div>
  );
}
